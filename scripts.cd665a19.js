...
(function ($) {
  ...
  scA.marquee('pause'); //// Menu Animations End
  ...
  $('.menu-item a').not('.no-trans').on('click', function () {
    ...
    setTimeout(function () {
      $('.sub-menu').removeClass('sub-menu-in'); //  $('.sub-menu .sub-menu').removeClass('sub-sub-in')
  ...
  $(window).on('load', function () {
    ////////// Page Loader /////////
    setTimeout(function () {
      document.querySelectorAll('.is-inview-remove-onload').forEach(function (item) {
    ...
    anime({
      ...
      delay: 0,
      easing: 'easeInOutCubic',
      update: function update(anim) {// var number = $('.cygni-loader .counter').html();
        // if (number < 10) {
    ...
    if ($('.list-v2').length > 0) {
      ...
      project.each(function (i) {
        ...
        $('.lv2-images').append(listv2Img); // if (i < 10) {
      ...
      var detailedImages = new Swiper('.detailed-images', {
        ...
        on: {
          ...
          progress: function progress() {
            ...
            for (var _i = 0; _i < swiper.slides.length; _i++) {
              var slideProgress = swiper.slides[_i].progress,
                  innerOffset = swiper.width * interleaveOffset,
                  innerTranslate = slideProgress * innerOffset;
              swiper.slides[_i].querySelector(".slide-bgimg").style.transform = "translateY(" + innerTranslate + "px)";
            }
          },
          setTransition: function setTransition(speed) {
            ...
            for (var _i2 = 0; _i2 < swiper.slides.length; _i2++) {
              swiper.slides[_i2].style.transition = speed + "ms";
              swiper.slides[_i2].querySelector(".slide-bgimg").style.transition = speed + "ms";
            }
          },
        ...
        on: {
          progress: function progress() {
            ...
            for (var _i3 = 0; _i3 < swiper.slides.length; _i3++) {
              var slideProgress = swiper.slides[_i3].progress,
                  innerOffset = swiper.width * interleaveOffset,
                  innerTranslate = slideProgress * innerOffset;
            }
          },
          setTransition: function setTransition(speed) {
            ...
            for (var _i4 = 0; _i4 < swiper.slides.length; _i4++) {
              ...
              swiper.slides[_i4].querySelector(".big-image").style.transition = speed + "ms";
            }
          },
          transitionStart: function transitionStart() {
      ...
      var horImages = new Swiper('.cygni-horizontal-images', {
        ...
        on: {
          progress: function progress() {
            ...
            for (var _i5 = 0; _i5 < swiper.slides.length; _i5++) {
              var slideProgress = swiper.slides[_i5].progress,
                  innerOffset = swiper.width * interleaveOffset,
                  innerTranslate = slideProgress * innerOffset;
              swiper.slides[_i5].querySelector(".slide-bgimg").style.transform = "translateX(" + innerTranslate + "px)";
            }
          },
          setTransition: function setTransition(speed) {
            var swiper = this;

            for (var _i6 = 0; _i6 < swiper.slides.length; _i6++) {
              swiper.slides[_i6].style.transition = speed + "ms";
              swiper.slides[_i6].querySelector(".slide-bgimg").style.transition = speed + "ms";
            }
          }
        }
      });
      ...
      var horTitles = new Swiper('.cygni-horizontal-titles', {
        ...
        pagination: {
          ...
          renderProgressbar: function renderProgressbar(progressbarFillClass) {
            return '<span class="hor-current">1</span>' + '<span class="' + progressbarFillClass + '"></span>' + '<span class="hor-total"></span>';
          }
        }
      });
    ...
    if ($('.pe-video-style-2').length > 0) {
      var cVideo2 = new Plyr('.pe-video-2', {
        controls: ["play-large", "play", "progress", "duration", "mute", "volume", "fullscreen"]
      });
    ...
    if ($('.c-accordion').length > 0) {
      $('.accordion-title').each(function (i) {
        ...
        $('.accordion-content').hide(); // if (i < 10) {
        //     var dataIn = '0' + (i + 1);
        // };
        // if (i > 9) {
        //     var dataIn = i + 1;
